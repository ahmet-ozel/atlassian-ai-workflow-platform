"""Property 1 — API key masking is "…" + last-4.

# Feature: llm-provider-management, Property 1: API key masking is "…" + last-4

Validates Requirements 4.2, 4.3 of the ``llm-provider-management`` spec:
