# vps_credential_loader.ps1 â€” Generate platform/.env + services/atlassian_unified/.env from CREDENTIALS.md
...
$mcpEnvContent = @"
# =============================================================================
# services/atlassian_unified/.env â€” Generated by vps_credential_loader.ps1
# Generated: $(Get-Date -Format "yyyy-MM-ddTHH:mm:ssZ")
# WARNING: This file contains secrets. NEVER commit to git.
# =============================================================================
