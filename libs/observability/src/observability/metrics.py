"""Prometheus metric registry shared by platform services.
...
The two `_seconds_bucket` names are exposed by
...
class Metrics:
    ...
    #: of every Temporal workflow. Exposed as
    #: ``workflow_execution_duration_seconds_bucket`` etc.
    workflow_execution_duration_seconds: Histogram

    #: Per-tool MCP call latency in seconds. Exposed as
    ...
    #: provider / cost_tag. Increment by `cost_usd`
    #: per LLM activity.
