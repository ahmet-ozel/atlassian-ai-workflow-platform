/**
 * Sensitive_Env_Key matcher - TypeScript half of the TSPython ikiz modül.
 ...
 * C4 (TSPython parity) can compare both sides on the same input set.
 ...
 * `[A-Z][A-Z0-9_]{3,40}`.
 */
export declare const SENSITIVE_ENV_KEY_PATTERNS: readonly RegExp[];
/**
